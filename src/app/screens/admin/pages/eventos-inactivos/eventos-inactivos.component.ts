...
@Component({
  selector: 'app-eventos-inactivos',
  templateUrl: './eventos-inactivos.component.html',
  styleUrls: ['./eventos-inactivos.component.css'],
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class EventosInactivosComponent implements OnInit {
